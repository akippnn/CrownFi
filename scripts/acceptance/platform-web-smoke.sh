...
first_contestant_id="c10f1000-0000-0000-0000-000000011001"
second_contestant_id="c10f1000-0000-0000-0000-000000011002"
...
if positions != sorted(positions):
    raise SystemExit(
        f"Expected ordered values {needles!r} in {path}; positions were {positions!r}"
    )
PY
}
...
curl --fail --silent --show-error \
  ...
  --header "x-crownfi-user-id: $demo_user_id" \
  --data '{"kind":"custom","title":"Second Contestant Spotlight","slug":"second-contestant-spotlight","sort_order":-10,"is_visible":true,"settings_json":{"body":"Only Mika has this organizer-configured section."}}' \
  "http://127.0.0.1:8080/admin/platform/pageant-contestants/$second_contestant_id/sections" \
  >"$evidence_dir/second-contestant-section.json"
...
curl --fail --silent --show-error \
  "http://127.0.0.1:3000/platform/pageants/$pageant_id/contestants/$first_contestant_id" \
  >"$evidence_dir/contestant-first.html"
curl --fail --silent --show-error \
  "http://127.0.0.1:3000/platform/pageants/$pageant_id/contestants/$second_contestant_id" \
  >"$evidence_dir/contestant-second.html"
...
assert_contains "$evidence_dir/contestant-first.html" "Ariella Santos"
assert_contains "$evidence_dir/contestant-first.html" "Overview"
assert_contains "$evidence_dir/contestant-first.html" "Advocacy"
