...
### Step 1: Database
Configure Postgres in `web/.env` (see [`../setup/supabase.md`](../setup/supabase.md)):
```dotenv
...
Deploy contracts to Stellar Testnet (see [`../setup/deployment.md`](../setup/deployment.md)), then update `.env`:
```dotenv
STELLAR_MODE="live"
